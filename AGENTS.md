...
- `docs/onboarding.md` is the fresh-clone setup path: pi install and pin, Codex auth for the balancer, skill install, smoke test. Keep it true when any of those change.
